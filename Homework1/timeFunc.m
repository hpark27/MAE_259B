% Filename: timeFunc
% A function to run an implicit method simulation with 
% difference time stamp input
% input: timestamp output: terminal velocity of the system

%%
function t1 = timeFunc(time)
    N = 21;    % Number of DOF
    dt = time; % discrete time interval [s]
